        ...
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center">
              <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-blue-600 rounded-full flex items-center justify-center mr-4">
                <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                  <div className="w-5 h-5 bg-gradient-to-br from-green-500 to-blue-600 rounded-full"></div>
                </div>
              </div>
              <div>
                <div className="text-sm font-bold text-gray-300">TRICHY</div>
                <div className="text-2xl font-bold text-blue-400">SRM</div>
                <div className="text-xs text-gray-400">MEDICAL COLLEGE</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300 leading-relaxed">
                    SRM Institute of Allied Health Sciences,<br />
                    SRM Medical College Hospital & Research Centre,<br />
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300">+91 44 4743 1999</p>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300">info@srmist.edu.in</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="w-10 h-10 bg-blue-800 hover:bg-blue-900 rounded-full flex items-center justify-center transition-colors duration-200">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Subscribe to our newsletter to get the latest updates about admissions, events, and news.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex">
                ...
                />
                <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-6 py-3 rounded-r-lg transition-colors duration-200">
                  Subscribe
                </button>
              </div>
            </div>
            ...
            {/* Accreditation */}
            <div className="mt-8">
              <h4 className="text-lg font-semibold mb-4">Accredited By</h4>
              <div className="flex space-x-4">
                <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-gray-800">NAAC</span>
                </div>
                <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-gray-800">NBA</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <p className="text-gray-400 text-sm">
              © 2024 SRM Institute of Allied Health Sciences. All rights reserved.
            </p>
